...
var UserBusiness = /** @class */ (function () {
    ...
    UserBusiness.prototype.createUser = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var email, name, password, role, idGenerator, id, hashManager, hashPassword, userDatabase, authenticator, accessToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = user.email, name = user.name, password = user.password, role = user.role;
